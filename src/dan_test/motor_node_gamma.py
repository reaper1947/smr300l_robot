...
class Ros2MotorNode(Node):
    ...
    def motor_alarm_check(self):
        ...
        if self.alarm_1.arbitration_id == (0x580 | self.motor_id_right) and self.alarm_2.arbitration_id == (0x580 | self.motor_id_left):
    ...
    def check_motor_enable(self):
        ...
        if self.status_1.arbitration_id == (0x580 | self.motor_id_right) and self.status_2.arbitration_id == (0x580 | self.motor_id_left):
